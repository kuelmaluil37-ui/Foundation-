public class Main {
    public static void main(String[] args) {
        ...
        Course course2 = new Course("AD201", "Advanced Computer", 4);
        ...
        System.out.println("Student 1 ID (final method): " + student1.getId());
        System.out.println("Lecturer 1 Email (final method): " + C.getEmail());
        System.out.println("Admin Office (final method): " + admin.getOfficeNumber());

        System.out.println("Course 1 Code (final variable): " + course1.getCourseCode());
        System.out.println("Lecturer 1 Employee ID (final variable): " + C.getEmployeeId());
